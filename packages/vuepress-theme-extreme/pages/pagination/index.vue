<template>
  <main class="theme-content-container">
...
<script>
import { Pagination as PaginationCore } from '@vuepress/plugin-blog/lib/client/components';
